...
export function buildAiUpstreamRequest({ format, baseUrl, model, apiKey, messages, maxTokens, temperature, provider, jsonMode = false, jsonSchema }) {
  ...
  if (normalizedFormat === "responses") {
    ...
    body = {
      ...
      ...(jsonSchema && typeof jsonSchema === "object"
        ? { response_format: { type: "json_schema", json_schema: { name: "interview_questions", strict: true, schema: jsonSchema } } }
